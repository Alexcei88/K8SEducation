...
namespace OTUS.HomeWork.Clients
{
    ...
    public partial class DeliveryServiceClient
    {
        ...
        public System.Threading.Tasks.Task<DeliveryLocationDTO> DeliveryAsync(string orderNumber)
        {
            return DeliveryAsync(orderNumber, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<DeliveryLocationDTO> DeliveryAsync(string orderNumber, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Delivery/{orderNumber}");
